...
jam1.item_orders.create(quantity: 100, price: 2, order: order2)
record5.item_orders.create(quantity: 100, price: 2, order: order2)
alpaca2.item_orders.create(quantity: 100, price: 2, order: order2)

order3 = Order.create(name: "Ray", address: "1491 Street St", city: "Denver", state: "CO", zip: "80123", user: regular_user, status: 'packaged')

knit2.item_orders.create(quantity: 100, price: 2, order: order3)
record4.item_orders.create(quantity: 100, price: 2, order: order3)
record3.item_orders.create(quantity: 100, price: 2, order: order3)
alpaca4.item_orders.create(quantity: 100, price: 2, order: order3)

order4 = Order.create(name: "Ray", address: "1491 Street St", city: "Denver", state: "CO", zip: "80123", user: regular_user, status: 'pending')

knit1.item_orders.create(quantity: 100, price: 2, order: order4)
record1.item_orders.create(quantity: 100, price: 2, order: order4)
record2.item_orders.create(quantity: 100, price: 2, order: order4)
record6.item_orders.create(quantity: 100, price: 2, order: order4)
alpaca1.item_orders.create(quantity: 100, price: 2, order: order4)
alpaca3.item_orders.create(quantity: 100, price: 2, order: order4)
alpaca4.item_orders.create(quantity: 100, price: 2, order: order4)
jam5.item_orders.create(quantity: 100, price: 2, order: order2)

order5 = Order.create(name: "Jordan", address: "1491 Street St", city: "Denver", state: "CO", zip: "80123", user: regular_user, status: 'pending')

jam3.item_orders.create(quantity: 100, price: 2, order: order5)
jam2.item_orders.create(quantity: 100, price: 2, order: order5)
jam1.item_orders.create(quantity: 100, price: 2, order: order5)
donut1.item_orders.create(quantity: 100, price: 2, order: order5)

order6 = Order.create(name: "David", address: "1491 Street St", city: "Denver", state: "CO", zip: "80123", user: regular_user, status: 'pending')

donut4.item_orders.create(quantity: 100, price: 2, order: order6)
donut6.item_orders.create(quantity: 100, price: 2, order: order6)
donut3.item_orders.create(quantity: 100, price: 2, order: order6)
donut2.item_orders.create(quantity: 100, price: 2, order: order6)
donut5.item_orders.create(quantity: 100, price: 2, order: order6)
donut1.item_orders.create(quantity: 100, price: 2, order: order6)

order7 = Order.create(name: "David", address: "1491 Street St", city: "Denver", state: "CO", zip: "80123", user: regular_user, status: 'cancelled')

alpaca1.item_orders.create(quantity: 100, price: 2, order: order7)
jam4.item_orders.create(quantity: 100, price: 2, order: order7)
record1.item_orders.create(quantity: 100, price: 2, order: order7)
donut2.item_orders.create(quantity: 100, price: 2, order: order7)
record3.item_orders.create(quantity: 100, price: 2, order: order7)
donut1.item_orders.create(quantity: 100, price: 2, order: order7)
